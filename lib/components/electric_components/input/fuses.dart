...
class FusesForm extends StatefulWidget {
  const FusesForm({super.key});

  @override
  State<FusesForm> createState() => _FusesFormState();
}

class _FusesFormState extends State<FusesForm> {
