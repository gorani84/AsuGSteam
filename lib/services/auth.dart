...
class AuthService {
  ...
  Future<User?> signInWithEmailAndPassword(String email, String password, Function(String?) errorCallBack) async {
    try {
  ...
  Future<User?> registerWithEmailAndPassword(String email, String password, Function(String?) errorCallBack) async {
    try {
